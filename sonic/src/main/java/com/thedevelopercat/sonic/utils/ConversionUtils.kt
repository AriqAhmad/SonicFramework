...
import com.thedevelopercat.sonic.constants.MemoryConstants
import com.thedevelopercat.sonic.constants.TimeConstants
import java.io.*
...
object ConversionUtils {
    ...
    fun bitmap2Drawable(bitmap: Bitmap?): Drawable? {
        return if (bitmap == null)
            ...
            BitmapDrawable(SonicApplication.instance.resources, bitmap)
    }
